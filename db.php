...
*/
$db = mysql_connect("sql.mit.edu", "ty12", "soz85ceh") or die(mysql_error());

mysql_select_db("ty12+trekkrdb99", $db) or die(mysql_error());
...
mysql_query("CREATE TABLE IF NOT EXISTS photos (USERNAME VARCHAR(40) NOT NULL, TREKNAME VARCHAR(80) NOT NULL, GEOLOCATION DECIMAL(2,0) NOT NULL, PHOTO VARCHAR(80) NOT NULL)") or die
?>
